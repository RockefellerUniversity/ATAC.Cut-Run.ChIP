...
peaksToQC <- c("~/Downloads/SOX9CNR_D0_rep1_macs_peaks.narrowPeak", 
              "~/Downloads/SOX9CNR_D0_rep2_macs_peaks.narrowPeak",
              "~/Downloads/SOX9CNR_W6_rep1_macs_peaks.narrowPeak",
              "~/Downloads/SOX9CNR_W6_rep2_macs_peaks.narrowPeak")
...
In the peak calling lecture we made a plot of insert sizes (LINK!). This is a very important QC readout for ATACseq, and ATACseqQC has a function that makes a similar plot with just a path to a BAM file. 

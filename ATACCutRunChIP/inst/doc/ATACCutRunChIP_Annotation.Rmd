...
We will be using output from the differential peak analysis of ATACse Week 6 vs Week 0. The starting table can be found in the 'data' folder of the course.  
...
Read in the differential output table 'data/W6MinusD0.xlsx', make a GRanges and do the following:
...
reactome_result_plot <- pairwise_termsim(reactome_result_prom)
emapplot(reactome_result_plot, showCategory = 20, cex.params = list(category_label = 0.6))
```

...
---
## Base frequency with raw epigenomics data
...
```{r mycRep1ReadsAlpByCyclePlot3, warning=F, message=F, fig.width=5, fig.height=3}
...
```{r mycRep1ReadsQScoresPlot, warning=F, message=F, fig.width=5, fig.height=3}
library(ggplot2)
...
For a more in-detail review of working with fastqs in R you can check [here](https://rockefelleruniversity.github.io/Bioconductor_Introduction/presentations/singlepage/FastQInBioconductor.html).
...
We can review the QC of our samples by checking out the the output *html* file. We have uploaded the result for this [here]("data/SOX9CNR_D0_rep1_filtered.html") 
...
Exercises for working with fastqs can be found [here](../exercises/exercises/MyExercise1_exercises.html)

...
```{r processData_plottingFrdagmentLengths, echo=TRUE,eval=TRUE,cache=FALSE, fig.height=5, fig.width=7}
library(ggplot2)
...
```{r processData_plottfingFragmentLengths2, echo=TRUE,eval=TRUE,cache=FALSE, fig.height=5, fig.width=7}
...
```{r processData_plottingFragmentLengths24, echo=TRUE,eval=TRUE,cache=FALSE, fig.height=5, fig.width=7}
fragLenPlot+ 

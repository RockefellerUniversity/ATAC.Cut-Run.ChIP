...
```{r processData_plottfingFragmentLengths2, echo=TRUE,eval=TRUE,cache=FALSE,fig.width=6,fig.height=4}
...
First we need to extract the chromosome lengths from the fasta file.


```{r echo=T,eval=F, include = F, warning=F}
library(dplyr)
library(tibble)
...
## Make BAM file for Nucleosome free regions
...
---
## Prepare NF BAM for peak calling - ATACseq

...
We will take these filtered FASTQ files and continue with the analysis:
  ...
  * Identify areas of read build up by calling peaks, or areas of significant enrichment
...
We set the **scanBamFlag()** function parameters **isProperPair** to TRUE so as to only read in reads paired in alignment within our preset max fragment length (2000bp)
